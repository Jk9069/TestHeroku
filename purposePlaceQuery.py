...
class purposePlaceQuery():
	...
	def requestPurposePlace(self):
		...
		if self.latitude != None and self.longitude != None:
			...
			requestLink = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=5.4356,100.3091&radius=20000&key=AIzaSyARXZAr7XVLsPTI1e6veB99zuUmjYQEagI"
